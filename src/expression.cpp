...
string Addition::buildIR(CFG & cfg)
{
  ...
  IRInstr_add* add = new IRInstr_add(cfg.current_bb,Type::Int32,cfg.current_bloc,var,var1,var2);
...
string Soustraction::buildIR(CFG & cfg)
{
  ...
  string var2 = exp2->buildIR(cfg);
  string var = cfg.create_new_tempvar(Type::Int32);
  IRInstr_sub* sub = new IRInstr_sub(cfg.current_bb,Type::Int32,cfg.current_bloc,var,var1,var2);
...
string Multiplication::buildIR(CFG & cfg)
{
  ...
  string var2 = exp2->buildIR(cfg);
  string var = cfg.create_new_tempvar(Type::Int32);
  IRInstr_mul* mul = new IRInstr_mul(cfg.current_bb,Type::Int32,cfg.current_bloc,var,var1,var2);
...
string Division::buildIR(CFG & cfg)
{
  ...
  string var2 = exp2->buildIR(cfg);
  string var = cfg.create_new_tempvar(Type::Int32);
  IRInstr_div* div = new IRInstr_div(cfg.current_bb,Type::Int32,cfg.current_bloc,var,var1,var2);
...
string ExpressionUnaire::buildIR(CFG & cfg)
{
    ...
    if(isNegative)
    {
      ...
      var = exp->buildIR(cfg);
      IRInstr_neg* neg = new IRInstr_neg(cfg.current_bb,Type::Int32,cfg.current_bloc,var);
